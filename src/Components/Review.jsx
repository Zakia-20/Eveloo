...
import Tombe from "../assets/Tombe.mp4"
    ...
    return(
        ...
        <section className="section3">
           <div className="review">
                        <svg   width="119.795" height="19.094" viewBox="0 0 119.795 19.094">
                <defs>
              ...
              <p>
                 After much research, I decided on the
                 EVELO Galaxy with the Harmony 
                 transmission ansd purchased one for my
                  wife for Christmas. It wasn't long before 
                  I had to have the same machine for myself!
              </p>
              <h3 className="name">
                 Bruce & Millie
              </h3>
              <h5 className="subname">
                Vermont
              </h5>
           </div>
